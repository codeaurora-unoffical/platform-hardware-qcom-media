...
bool AudioBitstreamSM::initBitstreamPtr()
{
    ...
    if(ms11InputBuffer != NULL) {
        ...
        LOGE("MS11 input buffer not allocated");
        return false;
    }
    ...
    if(ms11DDEncOutputBuffer) {
        ...
        LOGE("MS11 DDEnc output buffer not allocated");
        return false;
    }
    ...
    if(ms11PCM2ChOutputBuffer) {
        ...
        LOGE("MS11 PCM2Ch output buffer not allocated");
        return false;
    }
    ...
    if(ms11PCM6ChOutputBuffer) {
        ...
        LOGE("MS11 PCM6Ch output buffer not allocated");
        return false;
    }
    return true;
}
