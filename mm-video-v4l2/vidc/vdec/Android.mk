...
libmm-vdec-inc          += $(TOP)/$(BASEPORT_PATH)/media/mm-core/inc
...
libmm-vdec-inc      	+= $(TOP)/$(BASEPORT_PATH)/media/libc2dcolorconvert
...
libmm-vdec-inc += $(TOP)/$(BASEPORT_PATH)/media/libstagefrighthw
endif
